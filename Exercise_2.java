// Time Complexity :isEmpty->O(1);push->O(1);pop->O(n)if n is no. of elements present;peek->O(1)
//
// Space Complexity :O(n),where n is no of elements present if we consider linked list
