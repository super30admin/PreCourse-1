...
//
// Space Complexity :o(max),if we say max is constant:space complexity will be constant
// Did this code successfully run on Leetcode :couldn't find it on leetcode
// Any problem you faced while coding this :regarding initialization of constructor
